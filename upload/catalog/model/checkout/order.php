...
class ModelCheckoutOrder extends Model {
    ...
    public function updateOrderPaymentAndShipping($order_id, $payment_data, $shipping_data) {
        $this->db->query("
            UPDATE `" . DB_PREFIX . "order` SET 
                payment_firstname = '" . $this->db->escape($payment_data['firstname']) . "',
                payment_lastname = '" . $this->db->escape($payment_data['lastname']) . "',
                payment_address_1 = '" . $this->db->escape($payment_data['address_1']) . "',
                payment_address_2 = '" . $this->db->escape($payment_data['address_2']) . "',
                payment_city = '" . $this->db->escape($payment_data['city']) . "',
                payment_postcode = '" . $this->db->escape($payment_data['postcode']) . "',
                payment_country = '" . $this->db->escape($payment_data['country']) . "',
                payment_method = '" . $this->db->escape($payment_data['method']) . "',
                shipping_firstname = '" . $this->db->escape($shipping_data['firstname']) . "',
                shipping_lastname = '" . $this->db->escape($shipping_data['lastname']) . "',
                shipping_address_1 = '" . $this->db->escape($shipping_data['address_1']) . "',
                shipping_address_2 = '" . $this->db->escape($shipping_data['address_2']) . "',
                shipping_city = '" . $this->db->escape($shipping_data['city']) . "',
                shipping_postcode = '" . $this->db->escape($shipping_data['postcode']) . "',
                shipping_country = '" . $this->db->escape($shipping_data['country']) . "'
