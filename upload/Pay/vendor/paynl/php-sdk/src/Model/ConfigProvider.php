    ...
    public function getModelConfig(): array
    {
        return [
            ...
            'invokables' => [
                ...
                'OrderStatusResponse'        => Response\OrderStatusResponse::class,
                'OrderCaptureResponse'       => Response\OrderCaptureResponse::class,
                'OrderApproveResponse'       => Response\OrderApproveResponse::class,
                'OrderDeclineResponse'       => Response\OrderDeclineResponse::class,
                'OrderCreateResponse'        => Response\OrderCreateResponse::class,
                'OrderVoidResponse'          => Response\OrderVoidResponse::class,
